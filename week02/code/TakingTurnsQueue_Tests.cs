...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The Expected result wasn't the one being returned, possible an error with queue item indexing
    ...
    // Defect(s) Found: Fixed the Enqueue functionin the PersonQueue class and all seems well now
